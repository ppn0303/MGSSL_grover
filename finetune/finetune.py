# python finetune.py --dataset tg407 --epochs 10 --output_path output_grover/test --batch_size 96 --input_model_file grover.pth > g_gin_tg407_RS.txt &
# python finetune.py --dataset tg407 --epochs 10 --output_path output_grover/test --batch_size 96 --emb_dim 1200 --input_model_file grover.pth 
...
def run_test(args: Namespace, logger: Logger = None):
    ...
    #set up model
#    model = GNN_graphpred(args)
    model = GNN_graphpred(best_state['args'])
